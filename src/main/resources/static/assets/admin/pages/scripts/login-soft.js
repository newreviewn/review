var Login = function () {
	...
	var handleRegister = function () {
		...
		jQuery('#register-submit-btn').click(function () {
			...
			let prefix=document.getElementsByName("prefix");
			let degree=document.getElementsByName("degree");
			let email=document.getElementsByName("email");
			let insitution=document.getElementsByName("Insitution");
			...
			let postal_code=document.getElementsByName("postal_code");
			alert(name.value);
			alert(prefix.value);
	        ...
	        /*第三部返回按钮*/
		jQuery('#register-back-btn_2').click(function () {
			jQuery('.register-form').show();
			jQuery('#details').hide();
		});
